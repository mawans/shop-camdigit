        ...
        <!-- Hero Section Start -->
        <section class="hero-section hero-1 style-hosting bg-cover fix" style="background-image: url('assets/img/hero/hero-bg-1.webp');">
                ...
                <div class="row g-4 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-3 wow fadeInUp" data-wow-delay=".4s">
                        <div class="hero-image">
                            <img src="assets/img/hosting/Cloud hosting-cuate.png" alt="img">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-4 justify-content-between align-items-center">
                        ...
                        <div class="col-lg-5 wow fadeInUp" data-wow-delay=".4s">
                            <div class="hosting-image">
                                <img src="assets/img/hosting/www-rafiki.png" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-wrapper">
                    <div class="row g-4">
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="faq-image">
                                <img src="assets/img/faq-banner.png" alt="img">
                            </div>
                        </div>
                        <div class="col-lg-6">

            ...
            {if $creditCardCvcFieldEnabled}
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <button id="cvvWhereLink" type="button" class="btn btn-link" data-bs-toggle="popover" data-content="<img src='{$BASE_PATH_IMG}/ccv.gif' width='210'>">
    ...
    <div class="fieldgroup-auxfields{if $remoteUpdate} hidden{/if}">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                ...
                <br>
                <a href="#" class="btn btn-default btn-sm" data-bs-toggle="modal" data-bs-target="#modalBillingAddress">{$LANG.paymentMethodsManage.addNewAddress}</a>
            </div>
        </div>
        ...
        <div class="modal-content">
            <form id="billingContactForm" action="{routePath('account-paymentmethods-billing-contacts-create')}" data-role="json-form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-bs-dismiss="modal">{$LANG.paymentMethods.close}</button>

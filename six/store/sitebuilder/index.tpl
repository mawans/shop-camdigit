    ...
    <div class="features" id="features">
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#essentials" aria-controls="essentials" role="tab" data-bs-toggle="tab">{lang key="store.siteBuilder.featuresEssentials"}</a></li>
                <li role="presentation"><a href="#social" aria-controls="social" role="tab" data-bs-toggle="tab">{lang key="store.siteBuilder.featuresSocial"}</a></li>
                <li role="presentation"><a href="#store" aria-controls="store" role="tab" data-bs-toggle="tab">{lang key="store.siteBuilder.featuresStore"}</a></li>
            </ul>

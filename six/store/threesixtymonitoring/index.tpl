        ...
        <div class="container">
            <ul class="nav nav-tabs" id="pills-tab" role="tablist">
                ...
                <li class="nav-item{if $websitePlanCount > 0} active{/if}{if $websitePlanCount > 0 && $serverPlanCount <= 0} nav-full-width{/if}" role="presentation">
                    <a class="nav-link" id="pills-website-tab" data-bs-toggle="tab" href="#pills-website" role="tab" aria-controls="pills-website" aria-selected="true">
                ...
                <li class="nav-item{if $websitePlanCount <= 0} active{/if}{if $serverPlanCount > 0 && $websitePlanCount <= 0} nav-full-width{/if}" role="presentation">
                    <a class="nav-link" id="pills-server-tab" data-bs-toggle="tab" href="#pills-server" role="tab" aria-controls="pills-server" aria-selected="false">
                    ...
                    <nav class="nav-secondary">
                        <ul class="nav nav-tabs" id="how-tab" role="tablist">
                            <li class="nav-item active" role="presentation">
                                <a class="nav-link" id="features-website-tab" data-bs-toggle="pill" href="#features-website" role="tab" aria-controls="features-website" aria-selected="true">
                                    {lang key="store.threesixtymonitoring.navTab.website"}
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="features-server-tab" data-bs-toggle="pill" href="#features-server" role="tab" aria-controls="features-server" aria-selected="false">
                    ...
                    <div class="panel-group" id="websiteFaqAccordion" role="tablist" aria-multiselectable="true">
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingOne">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqOne" aria-expanded="false" aria-controls="websiteFaqOne">
                                        {lang key="store.threesixtymonitoring.faq.q1"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqOne" aria-expanded="false" aria-controls="websiteFaqOne"></i>
                            </div>
                            <div id="websiteFaqOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingOne" data-bs-parent="#websiteFaqAccordion">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingThree">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqThree" aria-expanded="false" aria-controls="websiteFaqThree">
                                        {lang key="store.threesixtymonitoring.faq.q3"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqThree" aria-expanded="false" aria-controls="websiteFaqThree"></i>
                            </div>
                            <div id="websiteFaqThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingThree" data-bs-parent="#websiteFaqAccordion">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingFive">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqFive" aria-expanded="false" aria-controls="websiteFaqFive">
                                        {lang key="store.threesixtymonitoring.faq.q5"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqFive" aria-expanded="false" aria-controls="websiteFaqFive"></i>
                            </div>
                            <div id="websiteFaqFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingFive" data-bs-parent="#websiteFaqAccordion">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingSeven">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqSeven" aria-expanded="false" aria-controls="websiteFaqSeven">
                                        {lang key="store.threesixtymonitoring.faq.q7"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqSeven" aria-expanded="false" aria-controls="websiteFaqSeven"></i>
                            </div>
                            <div id="websiteFaqSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingSeven" data-bs-parent="#websiteFaqAccordion">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingNine">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqNine" aria-expanded="false" aria-controls="websiteFaqNine">
                                        {lang key="store.threesixtymonitoring.faq.q9"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqNine" aria-expanded="false" aria-controls="websiteFaqNine"></i>
                            </div>
                            <div id="websiteFaqNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingNine" data-bs-parent="#websiteFaqAccordion">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingTwo">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqTwo" aria-expanded="false" aria-controls="websiteFaqTwo">
                                        {lang key="store.threesixtymonitoring.faq.q2"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqTwo" aria-expanded="false" aria-controls="websiteFaqTwo"></i>
                            </div>
                            <div id="websiteFaqTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingTwo" data-bs-parent="#websiteFaqAccordion">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingFour">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqFour" aria-expanded="false" aria-controls="websiteFaqFour">
                                        {lang key="store.threesixtymonitoring.faq.q4"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqFour" aria-expanded="false" aria-controls="websiteFaqFour"></i>
                            </div>
                            <div id="websiteFaqFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingFour" data-bs-parent="#websiteFaqAccordion">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingSix">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqSix" aria-expanded="false" aria-controls="websiteFaqSix">
                                        {lang key="store.threesixtymonitoring.faq.q6"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqSix" aria-expanded="false" aria-controls="websiteFaqSix"></i>
                            </div>
                            <div id="websiteFaqSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingSix" data-bs-parent="#websiteFaqAccordion">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="websiteFaqHeadingEight">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#websiteFaqEight" aria-expanded="false" aria-controls="websiteFaqEight">
                                        {lang key="store.threesixtymonitoring.faq.q8"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#websiteFaqEight" aria-expanded="false" aria-controls="websiteFaqEight"></i>
                            </div>
                            <div id="websiteFaqEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="websiteFaqHeadingEight" data-bs-parent="#websiteFaqAccordion">
                                <div class="panel-body">
                    ...
                    <div class="panel-group" id="serverFaqAccordion" role="tablist" aria-multiselectable="true">
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingOne">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqOne" aria-expanded="false" aria-controls="serverFaqOne">
                                        {lang key="store.threesixtymonitoring.faq.q1"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqOne" aria-expanded="false" aria-controls="serverFaqOne"></i>
                            </div>
                            <div id="serverFaqOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingOne" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a1"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingThree">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqThree" aria-expanded="false" aria-controls="serverFaqThree">
                                        {lang key="store.threesixtymonitoring.faq.q3"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqThree" aria-expanded="false" aria-controls="serverFaqThree"></i>
                            </div>
                            <div id="serverFaqThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingThree" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a3"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingFive">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqFive" aria-expanded="false" aria-controls="serverFaqFive">
                                        {lang key="store.threesixtymonitoring.faq.q5"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqFive" aria-expanded="false" aria-controls="serverFaqFive"></i>
                            </div>
                            <div id="serverFaqFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingFive" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a5"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingSeven">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqSeven" aria-expanded="false" aria-controls="serverFaqSeven">
                                        {lang key="store.threesixtymonitoring.faq.q7"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqSeven" aria-expanded="false" aria-controls="serverFaqSeven"></i>
                            </div>
                            <div id="serverFaqSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingSeven" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a7"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingNine">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqNine" aria-expanded="false" aria-controls="serverFaqNine">
                                        {lang key="store.threesixtymonitoring.faq.q9"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqNine" aria-expanded="false" aria-controls="serverFaqNine"></i>
                            </div>
                            <div id="serverFaqNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingNine" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a9"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingEleven">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqEleven" aria-expanded="false" aria-controls="serverFaqEleven">
                                        {lang key="store.threesixtymonitoring.faq.q11"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqEleven" aria-expanded="false" aria-controls="serverFaqEleven"></i>
                            </div>
                            <div id="serverFaqEleven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingEleven" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingTwo">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqTwo" aria-expanded="false" aria-controls="serverFaqTwo">
                                        {lang key="store.threesixtymonitoring.faq.q2"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqTwo" aria-expanded="false" aria-controls="serverFaqTwo"></i>
                            </div>
                            <div id="serverFaqTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingTwo" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a2"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingFour">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqFour" aria-expanded="false" aria-controls="serverFaqFour">
                                        {lang key="store.threesixtymonitoring.faq.q4"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqFour" aria-expanded="false" aria-controls="serverFaqFour"></i>
                            </div>
                            <div id="serverFaqFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingFour" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a4"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingSix">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqSix" aria-expanded="false" aria-controls="serverFaqSix">
                                        {lang key="store.threesixtymonitoring.faq.q6"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqSix" aria-expanded="false" aria-controls="serverFaqSix"></i>
                            </div>
                            <div id="serverFaqSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingSix" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a6"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingEight">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqEight" aria-expanded="false" aria-controls="serverFaqEight">
                                        {lang key="store.threesixtymonitoring.faq.q8"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqEight" aria-expanded="false" aria-controls="serverFaqEight"></i>
                            </div>
                            <div id="serverFaqEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingEight" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
                                    {lang key="store.threesixtymonitoring.faq.a8"}
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading" role="tab" id="serverFaqHeadingTen">
                                <h5 class="panel-title">
                                    <a role="button" class="btn btn-link collapsed" data-bs-toggle="collapse" href="#serverFaqTen" aria-expanded="false" aria-controls="serverFaqTen">
                                        {lang key="store.threesixtymonitoring.faq.q10"}
                                    </a>
                                </h5>
                                <i class="fal fa-plus collapsed" data-bs-toggle="collapse" href="#serverFaqTen" aria-expanded="false" aria-controls="serverFaqTen"></i>
                            </div>
                            <div id="serverFaqTen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="serverFaqHeadingTen" data-bs-parent="#serverFaqAccordion">
                                <div class="panel-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="{lang key="close"}">

                ...
                <div class="col-xs-12 col-lg-8 col-lg-offset-2">
                    <div class="panel-group" id="nordvpnFaq">
                        <div class="panel">
                            ...
                            <div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1" data-bs-parent="#nordvpnFaq">
                        ...
                        <div class="panel">
                            <div class="panel-heading" id="heading2">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse2">
                                        {lang key="store.nordvpn.features.faq.question2"}
                                        <i class="fal fa-plus fa-lg"></i>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2" data-bs-parent="#nordvpnFaq">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" id="heading3">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="true" aria-controls="collapse3">
                                        {lang key="store.nordvpn.features.faq.question3"}
                                        <i class="fal fa-plus fa-lg"></i>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3" data-bs-parent="#nordvpnFaq">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            ...
                            <div id="collapse4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading4" data-bs-parent="#nordvpnFaq">
                                <div class="panel-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading" id="heading5">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="true" aria-controls="collapse5">
                                        {lang key="store.nordvpn.features.faq.question5"}
                                        <i class="fal fa-plus fa-lg"></i>
                                    </button>
                                </h2>
                            </div>
                            <div id="collapse5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading5" data-bs-parent="#nordvpnFaq">
                                <div class="panel-body">

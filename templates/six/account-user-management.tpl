        ...
        <tr>
            <td>
                ...
                {if $user->hasTwoFactorAuthEnabled()}
                    <i class="fas fa-shield text-success" data-bs-toggle="tooltip" data-placement="auto right" title="{lang key='twoFactor.enabled'}"></i>
                {else}
                    <i class="fas fa-shield text-grey" data-bs-toggle="tooltip" data-placement="auto right" title="{lang key='twoFactor.disabled'}"></i>
                {/if}
                <br>
                <small>

        ...
        <div class="container">
            <div id="marketgoo-testimonials" class="carousel slide" data-ride="carousel" data-interval="10000">
                <ol class="carousel-indicators">
                    <li data-bs-target="#marketgoo-testimonials" data-slide-to="0" class="active"></li>
                    <li data-bs-target="#marketgoo-testimonials" data-slide-to="1"></li>
                    <li data-bs-target="#marketgoo-testimonials" data-slide-to="2"></li>
                    <li data-bs-target="#marketgoo-testimonials" data-slide-to="3"></li>
                </ol>

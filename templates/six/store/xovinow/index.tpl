    ...
    <div class="content-block feature-tabs bg-white">
        <div class="container">
            ...
            <ul class="nav nav-tabs mt-sm-4 mt-md-4 mt-lg-5" role="tablist">
                <li role="presentation" class="active"><a href="#keywords" aria-controls="keywords" role="tab" data-bs-toggle="tab">{lang key="store.xoviNow.features.keywords.title"}</a></li>
                <li role="presentation"><a href="#advisor" aria-controls="advisor" role="tab" data-bs-toggle="tab">{lang key="store.xoviNow.features.advisor.title"}</a></li>
                <li role="presentation"><a href="#ranktracker" aria-controls="ranktracker" role="tab" data-bs-toggle="tab">{lang key="store.xoviNow.features.rankTracker.title"}</a></li>
                <li role="presentation"><a href="#siteaudit" aria-controls="siteaudit" role="tab" data-bs-toggle="tab">{lang key="store.xoviNow.features.siteAudit.title"}</a></li>
                <li role="presentation"><a href="#textoptimizer" aria-controls="textoptimizer" role="tab" data-bs-toggle="tab">{lang key="store.xoviNow.features.textOptimizer.title"}</a></li>
                <li role="presentation"><a href="#benchmarking" aria-controls="benchmarking" role="tab" data-bs-toggle="tab">{lang key="store.xoviNow.features.benchmarking.title"}</a></li>
            </ul>
                    ...
                    <div class="panel-group" id="xovinowFAQ" role="tablist">
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading1">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                        {lang key="store.xoviNow.faq1"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1" data-bs-parent="#xovinowFAQ">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading2">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left collapsed" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                        {lang key="store.xoviNow.faq2"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading2" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading3">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left collapsed" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                        {lang key="store.xoviNow.faq3"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading4">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse4" aria-expanded="true" aria-controls="collapse4">
                                        {lang key="store.xoviNow.faq4"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading4" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading5">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse5" aria-expanded="true" aria-controls="collapse5">
                                        {lang key="store.xoviNow.faq5"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading5" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading6">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse6" aria-expanded="true" aria-controls="collapse6">
                                        {lang key="store.xoviNow.faq6"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading6" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading7">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse7" aria-expanded="true" aria-controls="collapse7">
                                        {lang key="store.xoviNow.faq7"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading7" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading8">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse8" aria-expanded="true" aria-controls="collapse8">
                                        {lang key="store.xoviNow.faq8"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse8" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading8" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading9">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse9" aria-expanded="true" aria-controls="collapse9">
                                        {lang key="store.xoviNow.faq9"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse9" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading9" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading10">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse10" aria-expanded="true" aria-controls="collapse10">
                                        {lang key="store.xoviNow.faq10"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse10" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading10" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading11">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse11" aria-expanded="true" aria-controls="collapse11">
                                        {lang key="store.xoviNow.faq11"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse11" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading11" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" id="heading12">
                                <h2 class="panel-title mb-0">
                                    <a class="btn btn-link btn-block text-left" type="button" data-bs-toggle="collapse" data-bs-parent="#xovinowFAQ" href="#collapse12" aria-expanded="true" aria-controls="collapse12">
                                        {lang key="store.xoviNow.faq12"}
                                    </a>
                                </h2>
                            </div>
                            <div id="collapse12" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading12" data-bs-parent="#xovinowFAQ">
                                <div class="panel-body">

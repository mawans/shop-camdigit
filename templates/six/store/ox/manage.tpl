        ...
        <td class="text-right">
            <div class="menu-sm">
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-default btn-sm dropdown-toggle dropdown-hamburger" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content panel-primary">
                <div class="modal-header panel-heading">
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="{lang key='close'}"><span aria-hidden="true">&times;</span></button>

    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-bs-toggle="collapse" data-bs-target="#nav-landing-page" aria-expanded="false">
            ...
            <div aria-multiselectable="true" class="panel-group" id="accordion" role="tablist">
                <div class="panel panel-default">
                    <div class="panel-heading" id="faqOne" role="tab">
                        <h4 class="panel-title"><a aria-controls="collapseOne" aria-expanded="true" data-bs-parent="#accordion" data-bs-toggle="collapse" href="#collapseOne" role="button">{lang key="store.sitelock.faqOneTitle"}</a></h4>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" id="faqTwo" role="tab">
                        <h4 class="panel-title"><a aria-controls="collapseTwo" aria-expanded="false" class="collapsed" data-bs-parent="#accordion" data-bs-toggle="collapse" href="#collapseTwo" role="button">{lang key="store.sitelock.faqTwoTitle"}</a></h4>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" id="faqThree" role="tab">
                        <h4 class="panel-title"><a aria-controls="collapseThree" aria-expanded="false" class="collapsed" data-bs-parent="#accordion" data-bs-toggle="collapse" href="#collapseThree" role="button">{lang key="store.sitelock.faqThreeTitle"}</a></h4>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" id="faqFour" role="tab">
                        <h4 class="panel-title"><a aria-controls="collapseFour" aria-expanded="false" class="collapsed" data-bs-parent="#accordion" data-bs-toggle="collapse" href="#collapseFour" role="button">{lang key="store.sitelock.faqFourTitle"}</a></h4>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" id="faqFive" role="tab">
                        <h4 class="panel-title"><a aria-controls="collapseFive" aria-expanded="false" class="collapsed" data-bs-parent="#accordion" data-bs-toggle="collapse" href="#collapseFive" role="button">{lang key="store.sitelock.faqFiveTitle"}</a></h4>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" id="faqSix" role="tab">
                        <h4 class="panel-title"><a aria-controls="collapseSix" aria-expanded="false" class="collapsed" data-bs-parent="#accordion" data-bs-toggle="collapse" href="#collapseSix" role="button">{lang key="store.sitelock.faqSixTitle"}</a></h4>
                    </div>

        ...
        <div class="container">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h4 data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapseHelpMeChoose" class="panel-title expand">
            ...
            <div class="panel">
                <div class="panel-heading">
                <h4 data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapseAllCerts" class="panel-title expand">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h4 class="panel-title expand" data-bs-toggle="collapse" data-bs-parent="#accordion" data-bs-target="#collapseMultiYear">
                        <span class="arrow"><i class="fas fa-chevron-right"></i></span>
            ...
            <div class="panel">
                <div class="panel-heading">
                <h4 data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapseFaq" class="panel-title expand">
                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
...
jQuery(document).ready(function() {
    jQuery(".panel-heading .panel-title[data-bs-toggle='collapse']").on("click", function() {
